    ...
    private void buttonSetOnClick() {
        btnLogin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (stremail.equals("")) {
                ...
                } else if ((!stremail.equals("dang")) || (!strpassword.equals("123"))) {
                    ...
                    editor.putString("name", "Nguyen Hong Dang");
                    editor.putString("address", "0x7C81d26eA0b2B89B871bdc091f7895782804Df3c");
                    editor.putString("date of birth", "06/11/1998");
                    editor.putString("email", "dang");
